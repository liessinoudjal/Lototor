 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Lototor');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Lototor');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Lotoquine Grille');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Lototor - Lototor.com");
 ...
 */
define ('PDF_IMAGE_SCALE_RATIO', 1.50);

/**
 * Magnification factor for titles.
 */
define('HEAD_MAGNIFICATION', 1.5);

/**
 * Height of cell respect font height.
 */
define('K_CELL_HEIGHT_RATIO', 3);
